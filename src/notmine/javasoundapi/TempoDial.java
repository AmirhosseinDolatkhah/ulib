...
public class TempoDial extends JPanel {
	...
	Dimension d = getSize();
        ...
        double x = ellipse.getWidth()/2+ellipse.getX()+ dotSize / 2.0;
        double y = ellipse.getHeight()/2;
        double x2 = currentData.dot.getX() + dotSize / 2.0;
        double y2 = currentData.dot.getY() + dotSize / 2.0;
