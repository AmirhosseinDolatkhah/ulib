...
public class PairBestDist implements Comparable<PairBestDist> {
	...
	public PairBestDist(Solution sol, double TotalCost) {
		this.sol = sol;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PairBestDist other = (PairBestDist) obj;
		if (id != other.id)
			return false;
		if (sol == null) {
			if (other.sol != null)
	...
	@Override
	public int compareTo(PairBestDist o) {
